...
export default function ErrorPage(){
    return (
        <div className="bg-[url('./assets/about_page/bg3.jpg')] bg-center text-center flex flex-col gap-8 mx-auto z-1 py-40 px-60 relative">
            ...
            <div className="flex flex-col gap-2 font-[Eater] relative z-1">
                <h1 className="text-6xl leading-tight text-white">Uh-oh… Something went horribly deliciously  <span className="text-[#EB5B00]">wrong</span>!</h1>
                <h2 className="font-light text-[#EB5B00]">Looks like the kitchen spirits are having a meltdown again.</h2>
            </div>
            <div className="mx-6 relative z-1 text-white">
