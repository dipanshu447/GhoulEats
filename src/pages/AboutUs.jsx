...
export default function AboutUs() {
    return (
        <div>
            <div className="bg-[url('./assets/about_page/bg.jpg')] bg-center bg-no-repeat text-center flex flex-col gap-8 z-1 py-20 sm:py-30 px-6 md:px-40 lg:px-60 relative">
                ...
                <div className="flex flex-col gap-2 font-[Eater] relative z-1">
                    <h1 className="text-4xl md:text-6xl leading-tight">Behind the <span className="text-[#EB5B00]">Cauldron</span></h1>
                    <h2 className="font-light text-[#EB5B00] text-sm sm:text-base">Where every recipe is born under moonlight and stirred by mischief.</h2>
                </div>
            ...
            <div className="px-6 md:px-20 mt-8 sm:mt-15 relative isolate overflow-hidden">
                <div className="flex flex-col gap-2">
                    <h1 className="text-2xl sm:text-4xl font-[Eater]">Our <span className="text-[#EB5B00]">Origin</span></h1>
                    <small className="font-light tracking-widest ml-1 ">Cooked in Chaos. Served with Charm.</small>
                </div>
                <p className="font-light ml-1 mt-6 text-sm sm:text-base">
            ...
            <div className="px-6 md:px-20 mt-8 sm:mt-15 relative isolate overflow-hidden">
                <div className="flex flex-col gap-2">
                    <h1 className="text-2xl sm:text-4xl font-[Eater]">Our <span className="text-[#EB5B00]">Philosophy</span></h1>
            ...
            <div className="flex flex-col gap-6 mt-8 sm:mt-15 md:mt-25 px-6 md:px-20 z-1">
                <div className="flex flex-col gap-3 text-center">
                    <h1 id="Meet-Our-Creepy-Cute-Crew!" className="text-2xl sm:text-4xl font-[Eater]">Meet Our <span className="text-[#EB5B00]">Crew</span></h1>
            ...
            <div className="mt-8 sm:mt-15 md:mt-25 px-6 md:px-20 relative flex flex-col sm:flex-row gap-10 items-center isolate">
                <div className="flex-1">
                    <div className="flex flex-col gap-2">
                        <h1 className="text-2xl sm:text-4xl font-[Eater]">The Secret <span className="text-[#EB5B00]">Kitchen</span></h1>
            ...
            <div className="bg-[url('./assets/welcome_page/halloween_theme_bg4.jpg')] bg-center w-full py-32 px-6 sm:px-15 md:px-40 relative z-10 mt-5 flex flex-col justify-center">
                ...
                <div className="flex flex-col text-center z-10 relative">
                    <h1 className="text-4xl md:text-5xl font-[Eater]">Join the Feast of <span className="text-[#EB5B00]">Freaks</span></h1>
                    <p className="font-light text-gray-300 mt-10 font-[Jolly_Lodger] text-xl sm:text-3xl">Every soul who steps into GhoulEats becomes part of our coven. Whether you’re a chef, a foodie, or a creature of the night, there’s always a seat waiting for you at our haunted table.</p>
                    <p className="font-light text-gray-300 mt-10 font-[Jolly_Lodger] text-xl sm:text-3xl">Join the feast, share your screams, and remember - the night never ends at GhoulEats..</p>
                </div>
