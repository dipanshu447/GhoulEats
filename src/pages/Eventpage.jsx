...
export default function Eventpage() {
    return (
        <div>
            <div className="bg-[url('./assets/welcome_page/halloween_theme_bg10.jpg')] bg-center text-center flex flex-col gap-8 self-center mx-auto z-1 py-20 sm:py-30 px-6 md:px-40 lg:px-60 relative">
                ...
                <div className="flex flex-col gap-3 relative z-1">
                    <h1 className="text-4xl md:text-6xl leading-tight font-[Eater]">Join the Feast of <span className="text-[#EB5B00]">Shadows</span>!</h1>
                    <h2 className="font-light text-[#EB5B00] text-sm sm:text-base">From haunted dinners to eerie costume nights - discover what’s brewing this season.</h2>
                </div>
            </div>
            <div className="flex flex-col gap-5 px-6 md:px-20 justify-center">
                {events.map(event => (
                    <div key={event.id} className="bg-[#0a0a25] p-6 rounded-2xl border border-[#1a1a3a] hover:border-[#ff7b00] transition-all duration-300 flex flex-col gap-2">
                        ...
                        <div className="text-sm sm:text-base">Location: {event.location}</div>
            ...
            <div className="bg-[url('./assets/welcome_page/halloween_theme_bg4.jpg')] bg-center w-full py-32 px-6 sm:px-15 md:px-40 relative z-10 mt-5 flex flex-col justify-center">
                ...
                <div className="flex flex-col text-center z-10 relative">
                    <h1 className="text-5xl md:text-6xl font-[Eater]">Join or Host an Event <span className="text-[#EB5B00]">Section</span></h1>
                    <p className="font-light text-gray-300 mt-10 font-[Jolly_Lodger] text-base sm:text-3xl">Want to host your own Halloween party at GhoulEats? We’ll handle the scares and snacks.</p>
                </div>
